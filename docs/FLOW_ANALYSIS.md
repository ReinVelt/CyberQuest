...
| **Flags set (sub-modules)** | `usb_analyzed`, `viewed_schematics`, `evidence_unlocked`, `started_ally_search`, `contacted_allies`, `david_contacted`, `cees_contacted`, `astron_unlocked`, `jaap_contacted`, `all_allies_contacted`, `volkov_investigated`, `contacted_kubecka`, `discovered_zerfall`, `identified_eva`, `eva_contacted` |
