 ...
 *   volkov   → Terminal: OSINT deep-dive on Dmitri Volkov / GRU 29155
...
window.LaptopScreen = (function () {
    ...
    function _colour(s) {
        return _esc(s)
            ...
            .replace(/(ZERFALL|Unit 29155|GRU)/g,'<span class="t-warn">$1</span>')
