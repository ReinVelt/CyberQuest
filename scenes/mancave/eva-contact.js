...
window.MancaveEvaContact = (function () {
    ...
    const EVA_MESSAGES = [
        ...
        { from: 'EVA_W', text: 'And then I remembered. Compascuum. Tony Knight\'s dog training weekend. Two years ago. Your partner Max and I both volunteer for the same rescue dog organisation.', timestamp: '03:19' },
        { from: 'Ryan', text: '...The dog training in Compascuum? That was you?', timestamp: '03:19' },
        { from: 'EVA_W', text: 'Max introduced us. You showed me your mancave. We talked about SDR, about mesh networks, about OSINT. You were passionate. And honest.', timestamp: '03:20' },
